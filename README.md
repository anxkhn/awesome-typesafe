...
- [Jev Plays Pokémon](https://github.com/anxkhn/JevPlaysPokemon) — FireRed emulator that lets Jev, or you, play and battle by choosing moves from the current game state.
