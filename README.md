...
- [Jev Plays Pokémon](https://github.com/anxkhn/JevPlaysPokemon) — A Pokémon agent that runs a FireRed emulator so you can play, make decisions in battle, let Jev pick the next move, and start from the included demo.
